...
class DetailCourse extends Component {
    ...
    render() {
        ...
        const { title, authInfo, cart, cartActions, asPath } = this.props;
        const params = {
            id: courseDetail.id,
                                ...
                                <div className="row">
                                    <div className="col-12 col-lg-8 site-content">
                                        <div className="visible-small">
                                            <BoxMeta authInfo={authInfo} courseBought={true} />
                                        </div>
                                    ...
                                    <div className="col-12 col-lg-4 widget-area">
                                        <div className="visible-large">
                                            <BoxMeta authInfo={authInfo} data={courseDetail} courseBought={true} />
                                        </div>
