...
class ReasonIconElement extends PureComponent {
    static defaultProps = {
        layout: 'full_width',
        idSection: 'sectionWhy',
        headingTitle: 'VÌ SAO?',
        subHeading: 'nên giảng dạy trên <b>Kaixin.vn</b>'
    };
