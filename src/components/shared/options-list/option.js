...
export default class Option extends PureComponent {
    ...
    renderSection = () => {
        ...
        return (
            <div>
                <OptionComponent onChange={this.onChange} value={value} OptionsList={OptionsList} {...extraProps} />
                {children}
            </div>
        );
    };
    ...
    renderOption = () => {
        const { type, tight, label, description, children, elementOverride, displayOverride, disabled } = this.props;
        ...
        return (
            <div className={cx(styles.option, tight && styles.tight)}>
                ...
                <div>
                    ...
                    {!label && overridable && <div className={styles.sideOverrides}>{this.renderOverrides()}</div>}
                </div>
                {children}
            </div>
        );
